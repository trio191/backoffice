...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="assets/assets/" data-template="vertical-menu-template">
          ...
          <div class="content-wrapper">
              ...
              <div class="col-lg-12 text-container" style="max-width: 1440px;padding-left: 100px;padding-right: 100px;">
                ...
                <div class="row pt-2">
                  ...
                  <div class="col-lg-5" style="text-align: right;">
                    <button type="button" data-bs-toggle="offcanvas" data-bs-target="#addYacht" aria-controls="addYacht" class="btn btn-white waves-effect waves-light" style="border-radius: 0px !important;color: #00365d;">
                      <img src="assets/img/yacht-black.png" style="width: 20%" class="me-1" /> Add yacht </button>
                  </div>
                </div>
              </div>
            </div>
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-12 mt-5">
                <div class="row">
                  <div class="col-lg-3">
                    <div class="card" style="border: 1px solid #C6D2E7;height: 85px;box-shadow: none !important ;background: url('assets/img/card-corner.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                          <b><small style="font-size: 9px">Total yacht maintenance</small></b>
                  ...
                  <div class="col-lg-3">
                    <div class="card" style="border: 1px solid #C6D2E7;height: 85px;box-shadow: none !important;background: url('assets/img/card-corner.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                          <b><small style="font-size: 9px">Latest job post</small></b>
                  ...
                  <div class="col-lg-3">
                    <div class="card" style="border: 1px solid #C6D2E7;height: 85px;box-shadow: none !important;background: url('assets/img/card-corner.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                          <b><small style="font-size: 9px">Latest job reply</small></b>
                  ...
                  <div class="col-lg-3">
                    <div class="card" style="border: 1px solid #FF005C;height: 85px;box-shadow: none !important;background: url('assets/img/card-corner-red.png');background-size: 100% 100% ;padding: 20px;border-radius: 0px;color: #00365E;">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                          <b><small style="font-size: 9px">Top yacht invested</small></b>
                          <h6 class="mb-0" style="color: #FF005C">Fast & Smooth</h6>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <button type="button" class="btn dropdown-toggle waves-effect waves-light me-2" data-bs-toggle="dropdown" aria-expanded="false" style="color: #00365E; min-width: 185px; padding: 10px 20px; ">
    Order By: Incidents
  </button>
  <button type="button" class="btn dropdown-toggle waves-effect waves-light" data-bs-toggle="dropdown" aria-expanded="false" style="color: #00365E; min-width: 120px; padding: 10px 20px; ">
    All Crew
  </button>
</div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-10 p-3">
                          <div class="row">
                            <div class="col-lg-8" style="color:#00365E">
                              <div class="row">
                                ...
                                <div style="display: flex;margin-top: -15px;">
                                  <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Mooring: <span style="color:#00365E">0023340</span>
                                  </span>
                                  <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Size: <span style="color:#00365E">12m</span>
                                  </span>
                                  <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Tonnage: <span style="color:#00365E">XX GT</span>
                                  </span>
                                  <span class="me-3 " style="padding-top: 5px; color: #9CAFD1;font-size: 13px;">Last activity: <span style="color:#00365E">Yesterday</span>
                                  </span>
                                </div>
                              </div>
                            </div>
                            ...
                            <center>
                              <div class="mt-3" style="width: 99.8%;border-top: 1px solid #9CAFD1;"></div>
                            </center>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="addYacht" aria-labelledby="addYacht" style="width: 500px !important;">
      <div class="offcanvas-header border-bottom">
        <h5 id="offcanvasEndLabel" style="color:#00365E;font-size: 18px" class="offcanvas-title">
          <i class="ti ti-arrow-left ti-md me-2 text-reset" style="margin-top: -5px" data-bs-dismiss="offcanvas" aria-label="Close"></i> Add yacht
        </h5>
      </div>
