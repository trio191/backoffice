            ...
            <div class="layout-demo-wrapper" style=" padding-top: 20px;padding-bottom: 20px; position: relative;background: #f2f6fa;">
                  <div class="col-lg-12 text-container" style="max-width: 1440px;padding-left: 100px;padding-right: 100px;"> <!-- Text container -->
                      <div class="row pt-2">
                          <div class="col-lg-7 text-white">
                              ...
                              <div class="d-flex flex-wrap" style="margin-top:-10px">
                                ...
                                <label class="badge me-2" style="background-color: #2AD7B3;color: #fff;" >
                                  <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="ti ti-briefcase ti-xs me-2"></i>Hired</span>
                                </label>
                                <span class="d-flex align-items-center justify-content-center text-nowrap me-3" style="color:#00365E"><i class="ti ti-calendar ti-xs me-2"></i>Posted on: 23 January 2022</span>
                                <span class="d-flex align-items-center justify-content-center text-nowrap me-3" style="color:#00365E"><i class="ti ti-video ti-xs me-2"></i>Videos: 1</span>
                          ...
                          <button type="button" class="btn " style="border-radius: 0px !important;color: #00365d;border: 1px solid #C6D2E7;color: white;width: 20px;">
